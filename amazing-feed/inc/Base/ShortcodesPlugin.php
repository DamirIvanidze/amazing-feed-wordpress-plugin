...
class ShortcodesPlugin extends BaseControllerPlugin {
	...
	public function twbsFlatsTemplate( $atts )
	{
		...
		wp_enqueue_script( 'mixitup_js', $this->plugin_url . '/assets/js/modules/mixitup/mixitup.min.js', array( 'jquery' ), null, true );
		wp_enqueue_script( 'mixitup_multifilter_js', $this->plugin_url . '/assets/js/modules/mixitup/mixitup-multifilter.min.js', array( 'jquery' ), null, true );
		wp_enqueue_script( 'mixitup_pagination_js', $this->plugin_url . '/assets/js/modules/mixitup/mixitup-pagination.min.js', array( 'jquery' ), null, true );
	...
	public function amazingFeedVariable( $atts )
	{
		...
		return $output[ 'variables' ][ $attributes[ 'variable' ] ];
	}
}